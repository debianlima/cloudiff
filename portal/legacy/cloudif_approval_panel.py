...
ACTION_LABELS={'forgejo.propose-edit':'Criar proposta no Forgejo','forgejo.proposal.merge':'Mesclar pull request','deployment.validate':'Validar deploy sem efeitos','deployment.promote-test':'Promover para ambiente de teste','deployment.production.deploy':'Publicar em produção','deployment.production.rollback':'Reverter produção','deployment.production.homologation.deploy':'Publicar na homologação','deployment.production.homologation.rollback':'Reverter homologação','deployment.production.activate':'Pré-ativação de produção real','supabase.operation.records.change':'Alterar registros do Supabase','supabase.operation.sql.change':'Executar SQL no Supabase','supabase.operation.rls.change':'Alterar políticas RLS','supabase.operation.schema.change':'Alterar schema do banco','supabase.operation.secrets.read':'Exibir segredos do tenant'}
