...
class CodeDarkBadgesTests(unittest.TestCase):
    def test_code_identifiers_use_dark_surface_tokens(self):
        ...
        self.assertIn('background:var(--iff-wash);color:var(--iff-dark);border-color:var(--rule)',CSS)
    ...
    def test_neutral_status_badges_do_not_use_legacy_white(self):
        ...
        self.assertIn('background:var(--surface);color:var(--ink-2);border-color:var(--rule)',CSS)
