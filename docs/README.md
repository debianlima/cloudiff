...
| [`CATALOGO-DE-AGENTES.md`](CATALOGO-DE-AGENTES.md) | `.md` | Documento técnico ou operacional. |
| [`CATALOGO-DE-ROTAS.md`](CATALOGO-DE-ROTAS.md) | `.md` | Documento técnico ou operacional. |
| [`CATALOGO-DE-SERVICOS.md`](CATALOGO-DE-SERVICOS.md) | `.md` | Documento técnico ou operacional. |
...
| [`MAINTENANCE.md`](MAINTENANCE.md) | `.md` | Documento técnico ou operacional. |
| [`PLANO-DE-APERFEICOAMENTO.md`](PLANO-DE-APERFEICOAMENTO.md) | `.md` | Documento técnico ou operacional. |
| [`REPOSITORY_AUDIT.md`](REPOSITORY_AUDIT.md) | `.md` | Documento técnico ou operacional. |
| [`REQUIREMENTS.md`](REQUIREMENTS.md) | `.md` | Documento técnico ou operacional. |
