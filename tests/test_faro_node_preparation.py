...
assert dec['network_address']['status']=='fixed' and dec['network_address']['allowed_values']==['10.62.91.5'];assert dec['role']['status']=='fixed' and dec['role']['allowed_values']==['edge'];assert dec['capabilities']['status']=='derived';assert set(dec['capabilities']['allowed_values'])=={'inventory','health','telemetry-host','portal-host','agent-auto-update'};assert dec['form_factor']['status']=='fixed' and dec['form_factor']['allowed_values']==['virtual-machine-kvm']
