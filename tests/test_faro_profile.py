...
assert o['vcpu']==2 and o['ram_bytes']==7785426944 and o['configured_ram_bytes']==8589934592 and o['disk_bytes']==214748364800
assert o['lv_bytes']==212596686848 and o['root_filesystem_bytes']==208661176320
assert g['vcpu']=='gap-observed-2-required-4'
assert g['ram']=='pass'
assert g['disk']=='pass'
assert r['status']=='partially-satisfied'
...
print('FARO_PROFILE=PASS desired=4vCPU/8GiB/200GiB observed=2vCPU/DMI-8GiB/200GiB gap=cpu-only')
