...
assert fm['name']=='cloudiff' and fm['tipo_competencia']=='projeto' and fm['versao']=='0.1.2'
...
print('CLOUDIFF_PROJECT_SKILL=PASS version=0.1.2 compoe=2 referencia=13 anti_cycle=PASS')
