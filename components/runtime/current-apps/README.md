...
## Inventário automático de `components/runtime/current-apps`
...
| [`production-homologation-executor-current/`](production-homologation-executor-current/) | Diretório | Componentes implantados no host de runtime, Forgejo, Komodo e executores. |
| [`production-public-executor-current/`](production-public-executor-current/) | Diretório | Componentes implantados no host de runtime, Forgejo, Komodo e executores. |
| [`production-sealed-target-current/`](production-sealed-target-current/) | Diretório | Componentes implantados no host de runtime, Forgejo, Komodo e executores. |
