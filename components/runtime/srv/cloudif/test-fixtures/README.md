...
## Inventário automático de `components/runtime/srv/cloudif/test-fixtures`

Componentes implantados no host de runtime, Forgejo, Komodo e executores.

| Item | Tipo | Finalidade |
|---|---|---|
| [`node24-http/`](node24-http/) | Diretório | Componentes implantados no host de runtime, Forgejo, Komodo e executores. |
