...
## Inventário automático de `components/runtime/srv/cloudif/publication-gateway`

Componentes implantados no host de runtime, Forgejo, Komodo e executores.

| Item | Tipo | Finalidade |
|---|---|---|
| [`conf.d/`](conf.d/) | Diretório | Componentes implantados no host de runtime, Forgejo, Komodo e executores. |
