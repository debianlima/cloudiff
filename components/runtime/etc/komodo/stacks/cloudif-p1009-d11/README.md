...
## Inventário automático de `components/runtime/etc/komodo/stacks/cloudif-p1009-d11`

Componentes implantados no host de runtime, Forgejo, Komodo e executores.

| Item | Tipo | Finalidade |
|---|---|---|
| [`compose.yaml`](compose.yaml) | `.yaml` | Definição declarativa de serviços Docker Compose. |
