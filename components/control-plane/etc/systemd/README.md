...
## Inventário automático de `components/control-plane/etc/systemd`

Componentes implantados no plano de controle e no host de hospedagem.

| Item | Tipo | Finalidade |
|---|---|---|
| [`system/`](system/) | Diretório | Componentes implantados no plano de controle e no host de hospedagem. |
