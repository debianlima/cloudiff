...
L.append("    }")
L.append("")
L.append('    # CloudIFF MCP + OAuth BEGIN')
L.append('    location = /.well-known/oauth-authorization-server {')
L.append('        proxy_intercept_errors off;')
L.append('        proxy_pass http://127.0.0.1:18198/.well-known/oauth-authorization-server;')
...
L.append('    }')
L.append('')
L.append('    location = /.well-known/oauth-protected-resource {')
L.append('        proxy_intercept_errors off;')
L.append('        proxy_pass http://127.0.0.1:18198/.well-known/oauth-protected-resource;')
L.append('        proxy_set_header Host $host;')
L.append('        proxy_set_header X-Forwarded-Proto https;')
L.append('        proxy_set_header X-Real-IP $remote_addr;')
L.append('        add_header Cache-Control no-store always;')
L.append('    }')
L.append('')
L.append('    location = /.well-known/oauth-protected-resource/cloudiff/mcp {')
L.append('        proxy_intercept_errors off;')
L.append('        proxy_pass http://127.0.0.1:18198/.well-known/oauth-protected-resource/cloudiff/mcp;')
L.append('        proxy_set_header Host $host;')
L.append('        proxy_set_header X-Forwarded-Proto https;')
L.append('        proxy_set_header X-Real-IP $remote_addr;')
L.append('        add_header Cache-Control no-store always;')
L.append('    }')
L.append('')
L.append('    location = /cloudiff/mcp/oauth/authorize {')
L.append('        proxy_intercept_errors off;')
L.append('        proxy_pass http://127.0.0.1:18198;')
L.append('        proxy_set_header Host $host;')
L.append('        proxy_set_header X-Forwarded-Proto https;')
L.append('        proxy_set_header X-Real-IP $remote_addr;')
L.append('        add_header Cache-Control no-store always;')
L.append('    }')
L.append('')
L.append('    location = /cloudiff/mcp/oauth/resume {')
L.append('        auth_request /cloudiff/portal-auth;')
L.append('        error_page 401 = @cloudif_authentik_signin_v244;')
L.append('        proxy_intercept_errors off;')
L.append('        auth_request_set $auth_cookie $upstream_http_set_cookie;')
L.append('        add_header Set-Cookie $auth_cookie always;')
L.append('        auth_request_set $authentik_username $upstream_http_x_authentik_username;')
L.append('        auth_request_set $authentik_email $upstream_http_x_authentik_email;')
L.append('        auth_request_set $authentik_groups $upstream_http_x_authentik_groups;')
L.append('        proxy_pass http://127.0.0.1:18198;')
L.append('        proxy_set_header Host $host;')
L.append('        proxy_set_header X-Forwarded-Proto https;')
L.append('        proxy_set_header X-Real-IP $remote_addr;')
L.append('        proxy_set_header X-authentik-username $authentik_username;')
L.append('        proxy_set_header X-authentik-email $authentik_email;')
L.append('        proxy_set_header X-authentik-groups $authentik_groups;')
L.append('        add_header Cache-Control no-store always;')
L.append('    }')
L.append('')
L.append('    location = /cloudiff/mcp {')
L.append('        proxy_intercept_errors off;')
L.append('        proxy_http_version 1.1;')
L.append('        proxy_pass http://127.0.0.1:18198/mcp;')
L.append('        proxy_set_header Host $host;')
L.append('        proxy_set_header X-Forwarded-Proto https;')
L.append('        proxy_set_header X-Real-IP $remote_addr;')
L.append('        proxy_set_header X-Forwarded-For $proxy_add_x_forwarded_for;')
L.append('        proxy_buffering off;')
L.append('        proxy_request_buffering off;')
L.append('        proxy_read_timeout 3600s;')
L.append('        proxy_send_timeout 3600s;')
L.append('        add_header Cache-Control no-store always;')
L.append('    }')
L.append('')
L.append('    location ^~ /cloudiff/mcp/ {')
...
L.append('        add_header Cache-Control no-store always;')
L.append('    }')
L.append('    # CloudIFF MCP + OAuth END')
L.append("")
...
L.append("    }")
L.append("")
L.append("    location = /cloudiff/tenant-readiness {")
L.append('        if ($cloudif_kong_port = "") { return 404; }')
L.append("        add_header Content-Type text/plain;")
L.append("        add_header Cache-Control no-store always;")
L.append("        add_header X-CloudIF-Tenant $cloudif_effective_tenant always;")
L.append('        return 200 "$cloudif_effective_tenant\\n";')
L.append("    }")
L.append("")
