...
<section class="card platform-guide">
  ...
  <nav class="guide-index" aria-label="Seções do guia"><a href="#guia-runtime">Ambiente do projeto</a><a href="#guia-publicacoes">Publicações</a><a href="#guia-projetos">Projetos</a><a href="#guia-bancos">Bancos</a><a href="#guia-backup">Backup</a><a href="#guia-conexoes">Conexões externas</a><a href="#guia-conectores">Conectores</a><a href="#guia-ad">Administração</a><a href="#guia-grupos">Grupos</a><a href="#guia-regras">Regras</a></nav>
  <div class="guide-grid">
    ...
    <article id="guia-conexoes"><span>05</span><h2>Conexões com aplicações e ferramentas</h2><p>As integrações abaixo funcionam externamente pelos endereços HTTPS publicados pela CloudIFF.</p><ul><li><strong>Supabase para aplicações:</strong> use <code>https://&lt;tenant&gt;.cloudiff.duckdns.org</code> com <code>supabase-js</code>, aplicações web e mobile, REST/PostgREST, Auth/OAuth, Storage, Realtime por WebSocket, Edge Functions e Supabase Studio.</li><li><strong>Forgejo por HTTPS:</strong> use <code>git clone https://cloudiff.duckdns.org/git/&lt;usuario&gt;/cloudif-&lt;projeto&gt;.git</code>. Funciona com Git CLI, VS Code e IDEs com cliente Git para clone, pull e push autenticados.</li><li><strong>Komodo:</strong> use <code>https://komodoiff.duckdns.org/</code> para painel web, API HTTPS, webhooks e fluxos autorizados de terminal, automação e deploy.</li><li><strong>Agentes MCP:</strong> use <code>https://cloudiff.duckdns.org/cloudiff/mcp</code> com ChatGPT, Claude, Claude Code e outros clientes MCP HTTP autorizados.</li><li><strong>OAuth:</strong> callbacks <code>127.0.0.1:&lt;porta&gt;</code> retornam ao computador do usuário e não recebem redirecionamento no gateway.</li></ul><div class="guide-connection-example"><strong>Laboratório de Hardware</strong><br>Supabase: <code>https://iff1742962-laboratoriodehardware.cloudiff.duckdns.org</code><br>Forgejo HTTPS: <code>https://cloudiff.duckdns.org/git/iff1742962/cloudif-laboratorio-de-hardware.git</code><br>Komodo: <code>https://komodoiff.duckdns.org/</code><br>MCP: <code>https://cloudiff.duckdns.org/cloudiff/mcp</code><br>Claude Code: <code>--client-id &lt;ID do projeto&gt; --client-secret</code> e <code>claude mcp login cloudiff</code></div><p class="help"><strong>Outros métodos:</strong> para qualquer conexão ou ferramenta não listada nesta seção, verifique com a TI a compatibilidade, a segurança e a liberação necessária.</p><p>Não publique senhas, tokens, <code>state</code>, <code>code_challenge</code> ou códigos OAuth.</p></article>
