...
<section class="card platform-guide">
  ...
  <article class="guide-repository"><div><span class="guide-repository-kicker">Código e documentação</span><h2>GitHub e manual técnico</h2><p>O repositório documenta arquitetura, fluxogramas, agentes e funções, protocolos de reconciliação, modelo de dados, mensagens, aprovações, serviços, rotas e a finalidade de cada pasta e arquivo.</p></div><a class="btn" href="https://github.com/debianlima/cloudiff" target="_blank" rel="noopener noreferrer">Abrir GitHub do projeto</a></article>
