...
<section class="card platform-guide">
  ...
  <div class="guide-grid">
    ...
    <article id="guia-conexoes"><span>05</span><h2>Conexões externas</h2><p>Use os endereços conforme o tipo de protocolo. HTTPS já passa pelo proxy; Git SSH e PostgreSQL direto dependem do encaminhamento no gateway Maurício.</p><ul><li><strong>Git HTTPS:</strong> <code>git clone https://cloudiff.duckdns.org/git/&lt;usuario&gt;/cloudif-&lt;projeto&gt;.git</code>.</li><li><strong>Git SSH:</strong> <code>ssh://git@cloudiff.duckdns.org:2222/&lt;usuario&gt;/cloudif-&lt;projeto&gt;.git</code>. Requer WAN 2222 → 10.62.91.2:2222.</li><li><strong>PostgreSQL:</strong> host <code>&lt;tenant&gt;.cloudiff.duckdns.org</code>, porta <code>54400</code>, banco <code>postgres</code>, usuário <code>postgres.&lt;POOLER_TENANT_ID&gt;</code>. Requer WAN 54400 → 10.62.92.7:54400.</li><li><strong>Supabase HTTP:</strong> <code>https://&lt;tenant&gt;.cloudiff.duckdns.org</code> em 443.</li><li><strong>MCP:</strong> use <code>https://cloudiff.duckdns.org/cloudiff/mcp</code>. A rota recebe <code>POST</code> autenticado; um <code>GET</code> pode responder 404. Não use <code>https://&lt;tenant&gt;.cloudiff.duckdns.org/mcp</code>.</li><li><strong>OAuth:</strong> callbacks <code>127.0.0.1:&lt;porta&gt;</code> são locais do cliente e não recebem redirecionamento no gateway.</li></ul><div class="guide-connection-example"><strong>Laboratório de Hardware</strong><br>Git HTTPS: <code>https://cloudiff.duckdns.org/git/iff1742962/cloudif-laboratorio-de-hardware.git</code><br>Git SSH: <code>ssh://git@cloudiff.duckdns.org:2222/iff1742962/cloudif-laboratorio-de-hardware.git</code><br>PostgreSQL: <code>postgres.iff1742962-laboratoriodehardware@iff1742962-laboratoriodehardware.cloudiff.duckdns.org:54400/postgres</code><br>Supabase: <code>https://iff1742962-laboratoriodehardware.cloudiff.duckdns.org</code><br>MCP: <code>https://cloudiff.duckdns.org/cloudiff/mcp</code><br>Claude Code: <code>--client-id &lt;ID do projeto&gt; --client-secret</code></div><p>Não publique senhas, tokens, <code>state</code>, <code>code_challenge</code> ou códigos OAuth.</p></article>
