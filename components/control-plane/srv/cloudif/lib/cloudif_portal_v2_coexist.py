        ...
        if previous_post is not None:
            def do_POST(self):
                ...
                query_routed = parsed.path in PORTAL_PATHS and query_action in {
                    "admin-delete-project", "admin-delete-tenant", "admin-tenant-advanced", "backup-remote-config"
                }
