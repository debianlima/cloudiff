...
<section class="card platform-guide">
  ...
  <div class="guide-grid">
    ...
    <article id="guia-conexoes"><span>05</span><h2>Conectar aplicações e ferramentas</h2><p>Use somente as opções abaixo para acesso externo. Todas funcionam pelos endereços HTTPS publicados pela CloudIFF.</p><ul><li><strong>Supabase:</strong> use <code>https://&lt;tenant&gt;.cloudiff.duckdns.org</code> com <code>supabase-js</code>, aplicações web e mobile, REST/PostgREST, Auth, Storage, Realtime, Edge Functions e Supabase Studio.</li><li><strong>Forgejo por HTTPS:</strong> use <code>https://cloudiff.duckdns.org/git/&lt;usuario&gt;/cloudif-&lt;projeto&gt;.git</code> com Git CLI, VS Code e IDEs para clone, pull e push autenticados.</li><li><strong>Komodo por HTTPS:</strong> use <code>https://komodoiff.duckdns.org/</code> para acessar o painel web e as integrações HTTPS autorizadas.</li><li><strong>MCP por HTTPS:</strong> use <code>https://cloudiff.duckdns.org/cloudiff/mcp</code> com Claude, Claude Code, ChatGPT e outros clientes MCP HTTP autorizados.</li></ul><div class="guide-connection-example"><strong>Laboratório de Hardware</strong><br>Supabase: <code>https://iff1742962-laboratoriodehardware.cloudiff.duckdns.org</code><br>Forgejo HTTPS: <code>https://cloudiff.duckdns.org/git/iff1742962/cloudif-laboratorio-de-hardware.git</code><br>Komodo: <code>https://komodoiff.duckdns.org/</code><br>MCP: <code>https://cloudiff.duckdns.org/cloudiff/mcp</code></div><p class="help"><strong>Outras formas de conexão:</strong> verifique com a TI a compatibilidade e a liberação necessária.</p><p>Não publique senhas ou tokens.</p></article>
