...
(() => {{
 ...
 const modal=document.getElementById('project-delete-modal'),body=document.getElementById('project-delete-modal-body'),footer=document.getElementById('project-delete-modal-footer'),title=document.getElementById('project-delete-title'),subtitle=document.getElementById('project-delete-subtitle'),button=form.querySelector('button[type=submit]');
 ...
 function openModal(){{modal.hidden=false;modal.setAttribute('aria-hidden','false');document.body.classList.add('project-delete-modal-open')}}
 function closeModal(){{if(activeJob&&!terminal)return;modal.hidden=true;modal.setAttribute('aria-hidden','true');document.body.classList.remove('project-delete-modal-open')}}
 modal.querySelectorAll('[data-project-delete-close]').forEach(x=>x.onclick=closeModal);
