...
| [`cloudif_admin_project_delete.py`](cloudif_admin_project_delete.py) | `.py` | Implementa `_job_write`, `job_status`, `start_job`, `h`, `_rows`, `projects` e outros componentes. |
...
| [`cloudif_project_provision_worker.py`](cloudif_project_provision_worker.py) | `.py` | Implementa `log`, `atomic_job`, `set_state`, `run`, `verify_onboarding`, `main`. |
