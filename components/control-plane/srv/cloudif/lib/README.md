...
| [`cloudif_portal_artifact_upload.py`](cloudif_portal_artifact_upload.py) | `.py` | Implementa `_json_body`, `ticket_status`, `artifact_status`, `project_allowed`, `safe_metadata`, `_forward_upload` e outros componentes. |
