...
| [`cloudif_workspace_artifact.py`](cloudif_workspace_artifact.py) | `.py` | Implementa `_artifact_lock`, `ArtifactError`, `_root`, `_dir`, `_meta_path`, `_payload_path` e outros componentes. |
