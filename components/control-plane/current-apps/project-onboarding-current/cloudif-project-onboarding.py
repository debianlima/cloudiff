...
BASE_SCOPES=['project:read','workspace:probe','workspace:prepare','workspace:validate','workspace:test-static','workspace:preview-static','workspace:edit-preview','forgejo:plan-edit','approval:request-proposal','approval:read-own','forgejo:propose-edit','forgejo:proposal-read','forgejo:proposal-close','forgejo:proposal-delete-branch','forgejo:proposal-merge-plan','approval:request-merge','forgejo:proposal-merge','deployment:plan','approval:request-deploy','deployment:validate','approval:request-preview','deployment:preview']+['supabase:database-read','supabase:auth-read','supabase:storage-read','supabase:admin-read','supabase:change-plan','approval:request-supabase','supabase:change-execute','workspace:detect-multiservice','project:configuration-read','workspace:change-set-plan','approval:request-change-set','forgejo:propose-change-set','build:multiservice-plan','approval:request-multiservice-build','build:multiservice-execute','preview:multiservice-plan','approval:request-multiservice-preview','preview:multiservice-execute','preview:multiservice-delete','deployment:multiservice-plan','approval:request-multiservice-deployment','deployment:multiservice-execute','project:observability-read','project:runtime-status-read','project:runtime-reconcile-plan','project:environment-read','project:environment-plan','approval:request-environment-change','project:environment-execute','approval:request-environment-promotion','project:environment-promote','project:environment-secret-read','project:environment-secret-stage','project:environment-secret-plan','approval:request-secret-rotation','approval:request-secret-revocation','approval:request-secret-promotion','project:environment-secret-execute','project:toolchain-read','project:toolchain-plan','approval:request-toolchain-build','project:toolchain-build-execute','project:toolchain-activate-plan','approval:request-toolchain-activation','project:toolchain-activate-execute']
...
def instructions(slug,client_id,role_profile,environment):
 tools={'viewer':['project.get','project.technologies.detect','project.configuration.get','forgejo.proposal.list','supabase.tables.list','supabase.records.select'],'developer':['project.get','project.technologies.detect','project.manifest.validate','project.configuration.get','workspace.normalize.plan','workspace.artifact.upload.start','workspace.artifact.upload.chunk','workspace.artifact.upload.batch','workspace.artifact.import','workspace.artifact.upload.file','workspace.artifact.upload.file.select','workspace.artifact.upload.file.resolve','workspace.artifact.upload.ticket','workspace.artifact.upload.status','workspace.artifact.commit.plan','workspace.artifact.upload.complete','workspace.change-set.validate','forgejo.proposal.change-set.plan','approval.request-change-set-proposal','forgejo.proposal.change-set.create','workspace.prepare','workspace.validate','forgejo.propose-edit.plan','supabase.tables.list','supabase.records.select','supabase.sql.query','supabase.auth.users.list','supabase.storage.objects.list','supabase.records.change.plan'],'maintainer':['project.get','project.technologies.detect','project.manifest.validate','project.configuration.get','workspace.normalize.plan','workspace.artifact.upload.start','workspace.artifact.upload.chunk','workspace.artifact.upload.batch','workspace.artifact.import','workspace.artifact.upload.file','workspace.artifact.upload.file.select','workspace.artifact.upload.file.resolve','workspace.artifact.upload.ticket','workspace.artifact.upload.status','workspace.artifact.commit.plan','workspace.artifact.upload.complete','workspace.change-set.validate','forgejo.proposal.change-set.plan','approval.request-change-set-proposal','forgejo.proposal.change-set.create','forgejo.proposal.list','forgejo.proposal.merge.plan','supabase.tables.list','supabase.sql.query','supabase.records.change.plan','supabase.schema.change.plan'],'release-manager':['project.get','project.technologies.detect','project.configuration.get','deployment.plan','deployment.validate','supabase.tables.list','supabase.sql.query'],'project-admin':['project.get','project.technologies.detect','project.manifest.validate','project.configuration.get','workspace.normalize.plan','workspace.artifact.upload.start','workspace.artifact.upload.chunk','workspace.artifact.upload.batch','workspace.artifact.import','workspace.artifact.upload.file','workspace.artifact.upload.file.select','workspace.artifact.upload.file.resolve','workspace.artifact.upload.ticket','workspace.artifact.upload.status','workspace.artifact.commit.plan','workspace.artifact.upload.complete','workspace.change-set.validate','forgejo.proposal.change-set.plan','approval.request-change-set-proposal','forgejo.proposal.change-set.create','workspace.prepare','workspace.validate','forgejo.propose-edit.plan','forgejo.proposal.merge.plan','deployment.plan','supabase.tables.list','supabase.records.select','supabase.sql.query','supabase.auth.users.list','supabase.storage.objects.list','supabase.secrets.list','supabase.records.change.plan','supabase.sql.change.plan','supabase.rls.change.plan','supabase.schema.change.plan'],'test-operator':['project.get','project.technologies.detect','project.manifest.validate','project.configuration.get','deployment.promote-test.plan','supabase.tables.list','supabase.sql.query']}.get(role_profile,['project.get'])
 return {'mcp_endpoint':'https://cloudiff.duckdns.org/cloudiff/mcp','client_id':client_id,'project_slug':slug,'role_profile':role_profile,'environment':environment,'authentication':'OAuth 2.1 público com PKCE (token_endpoint_auth_method=none)','openapi_schema_url':'https://cloudiff.duckdns.org/cloudiff/mcp/openapi/'+client_id+'.json','privacy_policy_url':'https://cloudiff.duckdns.org/cloudiff/mcp/privacy','chatgpt_actions_oauth':{'client_secret_required':True,'client_secret_delivery':'portal_one_time_rotation','token_endpoint_auth_method':'client_secret_post','pkce':False,'callback_policy':'official_chat_openai_aip_callback','authorization_code_ttl_seconds':180},'database_connector':{'same_mcp_endpoint':True,'additional_authentication':False,'project_isolation':True,'read_tools_direct':True,'changes_require_plan_and_approval':True,'secret_values_require_owner_and_approval':True},'oauth':{'issuer':'https://cloudiff.duckdns.org','authorization_url':'https://cloudiff.duckdns.org/cloudiff/mcp/oauth/authorize','token_url':'https://cloudiff.duckdns.org/cloudiff/mcp/oauth/token','revoke_url':'https://cloudiff.duckdns.org/cloudiff/mcp/oauth/revoke','client_secret':'','token_endpoint_auth_method':'none','code_challenge_method':'S256','scopes':['mcp','offline_access'],'callbacks':{'claude':'https://claude.ai/api/mcp/auth_callback','chatgpt':'Copie a URL exata exibida pelo ChatGPT: https://chatgpt.com/connector/oauth/<callback_id>','llama_ollama':'Use a callback local do cliente, por exemplo http://127.0.0.1:<porta>/callback'}},'legacy_bearer':{'enabled':True,'delivery':'Somente por rotação autenticada e exibição única no Portal.','headers':{'Authorization':'Bearer <TOKEN_DO_PROJETO>','X-CloudIF-Client':client_id}},'first_tools':tools,'production':False}
