...
def instructions(slug,client_id,role_profile,environment):
 tools={'viewer':['project.get','project.technologies.detect','project.configuration.get','forgejo.proposal.list','supabase.tables.list','supabase.records.select'],'developer':['project.get','project.technologies.detect','project.manifest.validate','project.configuration.get','workspace.normalize.plan','workspace.artifact.upload.start','workspace.artifact.upload.chunk','workspace.artifact.upload.batch','workspace.artifact.import','workspace.artifact.upload.file','workspace.artifact.upload.ticket','workspace.artifact.upload.status','workspace.artifact.commit.plan','workspace.artifact.upload.complete','workspace.change-set.validate','forgejo.proposal.change-set.plan','approval.request-change-set-proposal','forgejo.proposal.change-set.create','workspace.prepare','workspace.validate','forgejo.propose-edit.plan','supabase.tables.list','supabase.records.select','supabase.sql.query','supabase.auth.users.list','supabase.storage.objects.list','supabase.records.change.plan'],'maintainer':['project.get','project.technologies.detect','project.manifest.validate','project.configuration.get','workspace.normalize.plan','workspace.artifact.upload.start','workspace.artifact.upload.chunk','workspace.artifact.upload.batch','workspace.artifact.import','workspace.artifact.upload.file','workspace.artifact.upload.ticket','workspace.artifact.upload.status','workspace.artifact.commit.plan','workspace.artifact.upload.complete','workspace.change-set.validate','forgejo.proposal.change-set.plan','approval.request-change-set-proposal','forgejo.proposal.change-set.create','forgejo.proposal.list','forgejo.proposal.merge.plan','supabase.tables.list','supabase.sql.query','supabase.records.change.plan','supabase.schema.change.plan'],'release-manager':['project.get','project.technologies.detect','project.configuration.get','deployment.plan','deployment.validate','supabase.tables.list','supabase.sql.query'],'project-admin':['project.get','project.technologies.detect','project.manifest.validate','project.configuration.get','workspace.normalize.plan','workspace.artifact.upload.start','workspace.artifact.upload.chunk','workspace.artifact.upload.batch','workspace.artifact.import','workspace.artifact.upload.file','workspace.artifact.upload.ticket','workspace.artifact.upload.status','workspace.artifact.commit.plan','workspace.artifact.upload.complete','workspace.change-set.validate','forgejo.proposal.change-set.plan','approval.request-change-set-proposal','forgejo.proposal.change-set.create','workspace.prepare','workspace.validate','forgejo.propose-edit.plan','forgejo.proposal.merge.plan','deployment.plan','supabase.tables.list','supabase.records.select','supabase.sql.query','supabase.auth.users.list','supabase.storage.objects.list','supabase.secrets.list','supabase.records.change.plan','supabase.sql.change.plan','supabase.rls.change.plan','supabase.schema.change.plan'],'test-operator':['project.get','project.technologies.detect','project.manifest.validate','project.configuration.get','deployment.promote-test.plan','supabase.tables.list','supabase.sql.query']}.get(role_profile,['project.get'])
