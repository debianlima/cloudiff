...
ACTION_LABELS={'forgejo.propose-edit':'Criar proposta no Forgejo','forgejo.proposal.merge':'Mesclar pull request','deployment.validate':'Validar deploy sem efeitos','deployment.promote-test':'Promover para ambiente de teste','deployment.production.deploy':'Publicar em produção','deployment.production.rollback':'Reverter produção','deployment.production.homologation.deploy':'Publicar na homologação','deployment.production.homologation.rollback':'Reverter homologação','deployment.production.activate':'Pré-ativação de produção real'}
