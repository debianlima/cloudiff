...
(function(){
 ...
 const model={slug:'',tab:'preview',view:'stage',data:null,csrf:'',approval:null,poll:null,busy:false};const body=layer.querySelector('[data-release-body]');
 ...
 function close(){layer.classList.remove('is-open');document.body.classList.remove('cloudif-modal-open');clearTimeout(model.poll);model.poll=null}
