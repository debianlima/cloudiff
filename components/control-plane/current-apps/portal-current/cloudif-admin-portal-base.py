...
<section class="project-final__section project-final__publication"><h3>Preview e publicação</h3><p><strong>W Preview · H Homologation · P Publication</strong></p><p class="project-final__meta">O Preview é vivo. Homologação congela código + runtime. Produção reutiliza exatamente o artefato homologado.</p><div class="project-final__status"><span class="pill info">W</span><span class="pill info">H</span><span class="pill ok">P</span></div><div class="project-final__actions"><button class="btn" type="button" data-release-flow-open data-project-slug="{h(slug)}">Gerenciar publicação</button><button class="btn light" type="button" data-publication-environments data-publication-tool="variables" data-project-slug="{h(slug)}">Variáveis</button><a class="btn light" href="/cloudiff/portal/?tab=publicacao">Abrir publicações</a></div></section>
