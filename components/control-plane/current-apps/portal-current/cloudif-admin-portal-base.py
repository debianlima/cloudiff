...
def _nav95_render(user,current):
    ...
    help_items=[('ajuda','Ajuda','', 'Primeiros passos',None),('ajuda-token','Tokens','', 'Rotação e armazenamento',None),('ajuda-conectar','Clientes','', 'Aplicações, Git, Komodo e MCP',None),('ajuda-aprovacoes','Papéis','', 'Como aprovações funcionam',None),('ajuda-ferramentas','Referência','', 'Ferramentas MCP',None)]
    administration=[]
