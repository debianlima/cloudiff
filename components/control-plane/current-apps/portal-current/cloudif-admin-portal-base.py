...
.pm-new-shell{--pm-accent:#157a2b;--pm-accent-dark:#0d5c1f;--pm-accent-soft:#edf7ef;--pm-text:#17201a;color:var(--pm-text);background:#fff;padding:0 28px 24px;color-scheme:light}
.pm-new-step{display:none}.pm-new-step.is-active{display:grid;gap:14px}.pm-new-steps li{cursor:pointer;transition:.18s ease}.pm-new-steps li.is-active{color:#fff;background:var(--pm-accent)}.pm-new-steps li.is-active:before{color:var(--pm-accent-dark);background:#fff}.pm-new-steps li.is-complete{color:var(--pm-accent-dark);background:var(--pm-accent-soft)}
...
.pm-new-nav{display:flex;align-items:center;justify-content:space-between;gap:10px}.pm-new-nav__right{display:flex;gap:10px}.pm-new-nav .btn.primary{background:var(--pm-accent)!important;border-color:var(--pm-accent)!important;color:#fff!important}.pm-new-nav .btn.primary:hover{background:var(--pm-accent-dark)!important}
.pm-tenant-create[hidden],.pm-tenant-select[hidden]{display:none!important}.pm-tenant-preview{display:grid;gap:5px;padding:12px;border:1px solid #b9ddc3;border-radius:10px;background:var(--pm-accent-soft)}.pm-tenant-preview span{font-size:.7rem;font-weight:800;letter-spacing:.05em;text-transform:uppercase;color:var(--pm-accent-dark)}.pm-tenant-preview code{font-size:.88rem;overflow-wrap:anywhere;color:#123f1d}
...
.pm-provision-list{display:grid;gap:9px;margin:0;padding:0;list-style:none}.pm-provision-list li{display:flex;gap:9px;align-items:flex-start;color:var(--c-muted,#64748b);font-size:.8rem;line-height:1.45}.pm-provision-list li:before{content:'✓';font-weight:900;color:#176b35}
