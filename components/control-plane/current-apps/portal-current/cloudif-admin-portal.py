...
<div id="pm197_new" class="wizard cloudif-wizard" role="dialog" aria-modal="true" aria-labelledby="pm197_new_title"><div class="wizard-box"><div class="wizard-head"><div><h3 id="pm197_new_title">Novo projeto</h3><p>Defina os dados essenciais. O CloudIFF prepara o repositório, o ambiente, o banco e a publicação de forma integrada.</p></div><button class="wizard-close" type="button" onclick="cloudifHideWizard('pm197_new')">×</button></div><div class="pm-new-shell"><ol class="pm-new-steps"><li data-step="1">Projeto</li><li data-step="2">Banco</li><li data-step="3">Tecnologia</li><li data-step="4">Provisionamento</li></ol><form id="pm197_new_form" method="post" action="{url('/action/project_action')}"><input type="hidden" name="csrf_token" value="{h(csrf_token)}"><input type="hidden" name="action" value="create_project"><input type="hidden" name="create_repo" value="1"><input type="hidden" name="setup_komodo" value="1"><div class="pm-new-layout"><div class="pm-new-main"><section class="pm-new-section"><div class="pm-new-section__head"><h4>Identificação</h4><p>Use um nome simples e uma descrição que explique o objetivo do projeto.</p></div><label class="pm-field"><span>Nome do projeto</span><input name="name" required maxlength="120" placeholder="Ex.: Sistema de Biblioteca" autocomplete="off"><small>O slug técnico será gerado automaticamente a partir deste nome.</small></label><label class="pm-field"><span>Descrição</span><textarea name="description" rows="3" maxlength="500" placeholder="Ex.: Aplicação para empréstimos, acervo e usuários."></textarea><small>Essa descrição será exibida na gestão do projeto e no repositório.</small></label></section><section class="pm-new-section"><div class="pm-new-section__head"><h4>Banco de dados</h4><p>Escolha como o projeto utilizará o tenant Supabase.</p></div><div class="pm-choice-grid"><label class="pm-choice"><input type="radio" name="db_mode" value="link" checked><strong>Vincular existente</strong><small>Usa um tenant já provisionado.</small></label><label class="pm-choice"><input type="radio" name="db_mode" value="create"><strong>Criar novo tenant</strong><small>Cria um tenant dedicado ao projeto.</small></label><label class="pm-choice"><input type="radio" name="db_mode" value="skip"><strong>Sem banco</strong><small>Projeto sem Supabase neste momento.</small></label></div><label class="pm-field pm-tenant-select"><span>Tenant existente</span><select name="tenant">{tenant_opts}</select><small>Somente tenants visíveis para sua conta aparecem aqui.</small></label></section><section class="pm-new-section"><div class="pm-new-section__head"><h4>Tecnologia web</h4><p>Selecione o runtime inicial. Essa escolha define o Dockerfile, o serviço e o template do repositório.</p></div><div class="pm-runtime-options"><label class="pm-choice"><input type="radio" name="runtime_template" value="static-nginx" checked><strong>Site estático + Nginx</strong><small>HTML, CSS e JavaScript. Simples e rápido.</small></label><label class="pm-choice"><input type="radio" name="runtime_template" value="node20"><strong>Node.js 20</strong><small>Express com runtime LTS.</small></label><label class="pm-choice"><input type="radio" name="runtime_template" value="node22"><strong>Node.js 22</strong><small>Express com LTS atual.</small></label><label class="pm-choice"><input type="radio" name="runtime_template" value="node24"><strong>Node.js 24</strong><small>Runtime homologado mais recente.</small></label><label class="pm-choice"><input type="radio" name="runtime_template" value="php83-apache"><strong>PHP 8.3 + Apache</strong><small>Aplicação PHP tradicional.</small></label></div></section></div><aside class="pm-new-summary" aria-label="Resumo do provisionamento"><div><h4>Resumo</h4><p>Revise o que será preparado automaticamente.</p></div><dl><div><dt>Projeto</dt><dd data-pm-summary="name">Nome ainda não informado</dd></div><div><dt>Banco</dt><dd data-pm-summary="db">Tenant existente</dd></div><div><dt>Tecnologia</dt><dd data-pm-summary="runtime">Site estático + Nginx</dd></div></dl><ul class="pm-provision-list"><li>repositório Forgejo e webhooks;</li><li>stack, container e terminal no Komodo;</li><li>tenant Supabase conforme a opção escolhida;</li><li>ACL inicial do proprietário;</li><li>template e publicação inicial.</li></ul></aside></div><div class="pm-new-footer"><button class="btn" type="submit">Criar e provisionar projeto</button><button class="btn gray" type="button" onclick="cloudifHideWizard('pm197_new')">Cancelar</button></div></form></div></div></div>{''.join(wizards)}'''
