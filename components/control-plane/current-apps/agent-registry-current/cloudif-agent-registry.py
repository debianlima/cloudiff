...
PROJECT_OBSERVABILITY_SCOPES=['project:observability-read']
PROJECT_RUNTIME_READ_SCOPES=['project:runtime-status-read']
PROJECT_RUNTIME_PLAN_SCOPES=['project:runtime-reconcile-plan']
...
PROJECT_SECRET_READ_SCOPES=['project:environment-secret-read']
PROJECT_SECRET_VALUE_READ_SCOPES=['project:environment-secret-read-plan','approval:request-secret-read','project:environment-secret-read-execute']
PROJECT_SECRET_WRITE_SCOPES=['project:environment-secret-stage','project:environment-secret-plan','approval:request-secret-rotation','approval:request-secret-revocation','approval:request-secret-promotion','project:environment-secret-execute']
...
PROJECT_ADMIN_SCOPES=['project:read','deployment:production-plan','supabase:migration-inspect','workspace:probe','workspace:prepare','workspace:validate','workspace:test-static','workspace:preview-static','workspace:edit-preview','forgejo:plan-edit','approval:request-proposal','approval:read-own','forgejo:propose-edit','forgejo:proposal-read','forgejo:proposal-close','forgejo:proposal-delete-branch','forgejo:proposal-merge-plan','approval:request-merge','forgejo:proposal-merge','deployment:plan','approval:request-deploy','deployment:validate','approval:request-preview','deployment:preview']+SUPABASE_ALL_SCOPES+PROJECT_DISCOVERY_SCOPES+PROJECT_CHANGE_SET_SCOPES+PROJECT_BUILD_READ_SCOPES+PROJECT_BUILD_WRITE_SCOPES+PROJECT_PREVIEW_READ_SCOPES+PROJECT_PREVIEW_WRITE_SCOPES+PROJECT_DEPLOYMENT_READ_SCOPES+PROJECT_DEPLOYMENT_WRITE_SCOPES+PROJECT_OBSERVABILITY_SCOPES+PROJECT_RUNTIME_READ_SCOPES+PROJECT_RUNTIME_PLAN_SCOPES+PROJECT_ENVIRONMENT_READ_SCOPES+PROJECT_ENVIRONMENT_WRITE_SCOPES+PROJECT_SECRET_READ_SCOPES+PROJECT_SECRET_WRITE_SCOPES+PROJECT_SECRET_VALUE_READ_SCOPES+PROJECT_TOOLCHAIN_READ_SCOPES+PROJECT_TOOLCHAIN_WRITE_SCOPES
ROLE_SCOPES={
 'viewer':['project:read','workspace:probe','approval:read-own','forgejo:proposal-read']+SUPABASE_BASIC_SCOPES+PROJECT_DISCOVERY_SCOPES+PROJECT_BUILD_READ_SCOPES+PROJECT_PREVIEW_READ_SCOPES+PROJECT_DEPLOYMENT_READ_SCOPES+PROJECT_OBSERVABILITY_SCOPES+PROJECT_RUNTIME_READ_SCOPES+PROJECT_ENVIRONMENT_READ_SCOPES+PROJECT_SECRET_READ_SCOPES+PROJECT_TOOLCHAIN_READ_SCOPES,
 'developer':['project:read','workspace:probe','workspace:prepare','workspace:validate','workspace:test-static','workspace:preview-static','workspace:edit-preview','forgejo:plan-edit','approval:request-proposal','approval:read-own','forgejo:propose-edit','forgejo:proposal-read']+SUPABASE_ALL_SCOPES+PROJECT_DISCOVERY_SCOPES+PROJECT_CHANGE_SET_SCOPES+PROJECT_BUILD_READ_SCOPES+PROJECT_BUILD_WRITE_SCOPES+PROJECT_PREVIEW_READ_SCOPES+PROJECT_PREVIEW_WRITE_SCOPES+PROJECT_DEPLOYMENT_READ_SCOPES+PROJECT_OBSERVABILITY_SCOPES+PROJECT_RUNTIME_READ_SCOPES+PROJECT_RUNTIME_PLAN_SCOPES+PROJECT_DEPLOYMENT_WRITE_SCOPES+PROJECT_ENVIRONMENT_READ_SCOPES+PROJECT_ENVIRONMENT_WRITE_SCOPES+PROJECT_SECRET_READ_SCOPES+PROJECT_SECRET_WRITE_SCOPES+PROJECT_TOOLCHAIN_READ_SCOPES+PROJECT_TOOLCHAIN_WRITE_SCOPES,
