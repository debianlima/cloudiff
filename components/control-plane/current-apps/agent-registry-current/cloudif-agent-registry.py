...
ROLE_SCOPES={
 'viewer':['project:read','workspace:probe','approval:read-own','forgejo:proposal-read']+SUPABASE_BASIC_SCOPES+PROJECT_DISCOVERY_SCOPES+PROJECT_BUILD_READ_SCOPES+PROJECT_PREVIEW_READ_SCOPES+PROJECT_DEPLOYMENT_READ_SCOPES+PROJECT_ENVIRONMENT_READ_SCOPES+PROJECT_SECRET_READ_SCOPES+PROJECT_TOOLCHAIN_READ_SCOPES,
